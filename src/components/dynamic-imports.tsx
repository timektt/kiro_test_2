...
export const RankingBoard = dynamic(
  () =>
    import('@/components/rankings/ranking-board').then((mod) => ({
      default: mod.RankingBoard,
    })),
  {
    loading: () => <LoadingSpinner />,
  }
...
export const MBTISelector = dynamic(
  () =>
    import('@/components/identity/mbti-selector').then((mod) => ({
      default: mod.MBTISelector,
    })),
  {
    loading: () => <LoadingSpinner />,
  }
...
export const ProfileEditForm = dynamic(
  () =>
    import('@/components/profile/profile-edit-form').then((mod) => ({
...
export const PostComposerModal = dynamic(
  () =>
    import('@/components/ui/post-composer').then((mod) => ({
      default: mod.PostComposer,
    })),
  {
    loading: () => <LoadingSpinner />,
  }
...
export const NotificationsList = dynamic(
  () =>
    import('@/components/notifications/notifications-list').then((mod) => ({
      default: mod.NotificationsList,
    })),
  {
    loading: () => (
