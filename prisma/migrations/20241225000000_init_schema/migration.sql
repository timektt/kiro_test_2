...
-- CreateEnum
CREATE TYPE "RankingType" AS ENUM ('POSTS_LIKES', 'POSTS_COUNT', 'COMMENTS_COUNT', 'FOLLOWERS_COUNT', 'ENGAGEMENT', 'WEEKLY_ACTIVE', 'MONTHLY_ACTIVE');
...
-- AddForeignKey
ALTER TABLE "mbti" ADD CONSTRAINT "mbti_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
